...
def display_overview(df, histories, dataset):
    ...
    st.markdown('<h2 class="section-header">📊 Performance Overview</h2>', 
                unsafe_allow_html=True)
...
def display_model_comparison(df, dataset):
    ...
    st.markdown('<h2 class="section-header">🔍 Model Architecture Comparison</h2>', 
                unsafe_allow_html=True)
...
def display_training_analysis(df, histories, dataset, model):
    ...
    st.markdown('<h2 class="section-header">📈 Training Analysis</h2>', 
                unsafe_allow_html=True)
...
def display_performance_deep_dive(df, dataset):
    ...
    st.markdown('<h2 class="section-header">🎯 Performance Deep Dive</h2>', 
                unsafe_allow_html=True)
